( function( $ ) {
	$( document ).ready( function() {
		...
		( function() {
			...
			// vc navbar
			var secion = '<li data-wntooltip="Add Section"><a href="#" class="vc_icon-btn vc_navbar-border-right wn-vc-section"><i class="ti-layout-slider"></i></a></li>',
			...
			$( '.vc_navbar' ).find( '.vc_navbar-nav' ).append( secion + row + paste );
