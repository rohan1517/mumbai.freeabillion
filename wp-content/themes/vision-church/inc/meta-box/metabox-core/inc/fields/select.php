...
class RWMB_Select_Field extends RWMB_Choice_Field
{
	...
	public static function get_select_all_html( $field )
	{
		...
		{
			return '<div class="rwmb-select-all-none">' . __( 'Select', 'vision-church' ) . ': <a data-type="all" href="#">' . __( 'All', 'vision-church' ) . '</a> | <a data-type="none" href="#">' . __( 'None', 'vision-church' ) . '</a></div>';
		}
		return '';
	}
}
