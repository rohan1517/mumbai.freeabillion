...
class crtext extends WP_Widget{
	...
	public function form($instance){
		...
		<p><label for="<?php echo esc_attr( $this->get_field_id('copyright') ); ?>"><?php esc_html_e('Copyright Text:','vision-church') ?></label><input type="text" class="widefat" id="<?php echo esc_attr( $this->get_field_id('copyright') ); ?>" name="<?php echo esc_attr( $this->get_field_name('copyright') ); ?>" value="<?php if( isset($copyright) )  echo esc_attr($copyright); ?>" /></p>
		<?php 
	}
...
add_action('widgets_init', 'register_vision_church_crtext');
function register_vision_church_crtext(){
