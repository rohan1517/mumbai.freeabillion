...
class Vision_Church_PopularPosts extends WP_Widget{
	function __construct(){
	$params = array('description'=> 'Display Popular Posts','name'=> 'Webnus-Popular Posts');
	parent::__construct('Vision_Church_PopularPosts', '', $params);
	}
...
add_action('widgets_init', 'register_vision_church_PopularPosts');
function register_vision_church_PopularPosts(){
	register_widget('Vision_Church_PopularPosts');
}