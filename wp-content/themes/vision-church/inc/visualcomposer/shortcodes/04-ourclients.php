...
vc_map( array(
		...
		'params'=>array(
					array(
							...
							"description" => esc_html__( "OurClients Type", 'vision-church')
					),
					array(
							'type' => 'attach_images',
							'heading' => esc_html__( 'Clients Images', 'vision-church' ),
							'param_name' => 'client_images',
							'value' => '',
							'description' => esc_html__( 'OurClients Images', 'vision-church')
					),
		)
