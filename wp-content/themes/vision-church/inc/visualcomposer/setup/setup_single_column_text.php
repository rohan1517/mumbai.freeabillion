...
if ( class_exists( 'WPBakeryVisualComposerAbstract' ) ) :
	...
	if ( ! function_exists( 'vision_church_setup_vc_column_text' ) ) :

		add_action( 'admin_init', 'vision_church_setup_vc_column_text' );

		function vision_church_setup_vc_column_text() {
			$attributes = array(
				array(
