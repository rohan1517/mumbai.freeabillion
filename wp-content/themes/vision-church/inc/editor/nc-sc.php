...
class Vision_Church_MyGallery
{
	...
	function filter_mce_plugin( $plugins ) {
		// this plugin file will work the magic of our button
                ...
                $plugins['vision_church_button'] = get_template_directory_uri() . '/inc/editor/nc-sc.js';
...
$mygallery = new Vision_Church_MyGallery();
