...
function z_add_texonomy_field() {
	...
	echo '<div class="form-field">
		<label for="taxonomy_image">' . __('Image', 'vision-church') . '</label>
		<input type="text" name="taxonomy_image" id="taxonomy_image" value="" />
		<br/>
		<button class="z_upload_image_button button">' . __('Upload/Add image', 'vision-church') . '</button>
	</div>'.z_script();
}
...
function z_edit_texonomy_field($taxonomy) {
	...
	echo '<tr class="form-field">
		<th scope="row" valign="top"><label for="taxonomy_image">' . __('Image', 'vision-church') . '</label></th>
		...
		<button class="z_upload_image_button button">' . __('Upload/Add image', 'vision-church') . '</button>
		<button class="z_remove_image_button button">' . __('Remove image', 'vision-church') . '</button>
		</td>
	</tr>'.z_script();
}
...
function z_taxonomy_columns( $columns ) {
	...
	$new_columns['thumb'] = __('Image', 'vision-church');
...
function z_taxonomy_column( $columns, $column, $id ) {
	if ( $column == 'thumb' )
		$columns = '<span><img src="' . z_taxonomy_image_url($id, NULL, TRUE) . '" alt="' . __('Thumbnail', 'vision-church') . '" class="wp-post-image" /></span>';
