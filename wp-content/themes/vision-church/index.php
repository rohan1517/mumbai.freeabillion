<?php
	...
	$vision_church_options['vision_church_blog_page_title_enable'] = isset($vision_church_options['vision_church_blog_page_title_enable']) ? $vision_church_options['vision_church_blog_page_title_enable'] : 'Blog' ;
	$vision_church_options['vision_church_blog_page_title'] = isset($vision_church_options['vision_church_blog_page_title']) ? $vision_church_options['vision_church_blog_page_title'] : '' ;
...
<?php // start headline		
	if($vision_church_options['vision_church_blog_page_title_enable']){
		echo'<section id="headline"><div class="container"><h2>'. $vision_church_options['vision_church_blog_page_title'] .'</h2></div></section>';
	} // end headline ?>
