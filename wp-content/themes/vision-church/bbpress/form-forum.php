			...
			<fieldset class="bbp-form">
				<legend>
					...
					<?php
						if ( bbp_is_forum_edit() )
							printf( esc_html__( 'Now Editing &ldquo;%s&rdquo;', 'vision-church' ), bbp_get_forum_title() );
						else
							bbp_is_single_forum() ? printf( esc_html__( 'Create New Forum in &ldquo;%s&rdquo;', 'vision-church' ), bbp_get_forum_title() ) : esc_html_e( 'Create New Forum', 'vision-church' );
					?>
				...
				<?php if ( !bbp_is_forum_edit() && bbp_is_forum_closed() ) : ?>
					...
					<div class="bbp-template-notice">
						<p><?php esc_html_e( 'This forum is closed to new content, however your account still allows you to do so.', 'vision-church' ); ?></p>
					</div>
				...
				<div>
					...
					<p>
						<label for="bbp_forum_title"><?php printf( esc_html__( 'Forum Name (Maximum Length: %d):', 'vision-church' ), bbp_get_title_max_length() ); ?></label><br />
					...
					<?php if ( !function_exists( 'wp_editor' ) ) : ?>
						...
						<p>
							<label for="bbp_forum_content"><?php esc_html_e( 'Forum Description:', 'vision-church' ); ?></label><br />
					...
					<p>
						<label for="bbp_forum_type"><?php esc_html_e( 'Forum Type:', 'vision-church' ); ?></label><br />
					...
					<p>
						<label for="bbp_forum_status"><?php esc_html_e( 'Status:', 'vision-church' ); ?></label><br />
					...
					<p>
						<label for="bbp_forum_visibility"><?php esc_html_e( 'Visibility:', 'vision-church' ); ?></label><br />
					...
					<p>
						<label for="bbp_forum_parent_id"><?php esc_html_e( 'Parent Forum:', 'vision-church' ); ?></label><br />

						<?php
							bbp_dropdown( array(
								'select_id' => 'bbp_forum_parent_id',
								'show_none' => esc_html__( '(No Parent)', 'vision-church' ),
					...
					<div class="bbp-submit-wrapper">
						...
						<button type="submit" tabindex="<?php bbp_tab_index(); ?>" id="bbp_forum_submit" name="bbp_forum_submit" class="button submit"><?php esc_html_e( 'Submit', 'vision-church' ); ?></button>
...
<?php elseif ( bbp_is_forum_closed() ) : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php printf( esc_html__( 'The forum &#8216;%s&#8217; is closed to new content.', 'vision-church' ), bbp_get_forum_title() ); ?></p>
		</div>
	</div>
...
<?php else : ?>
	...
	<div id="no-forum-<?php bbp_forum_id(); ?>" class="bbp-no-forum">
		<div class="bbp-template-notice">
			<p><?php is_user_logged_in() ? esc_html_e( 'You cannot create new forums at this time.', 'vision-church' ) : esc_html_e( 'You must be logged in to create new forums.', 'vision-church' ); ?></p>
		</div>
	</div>
