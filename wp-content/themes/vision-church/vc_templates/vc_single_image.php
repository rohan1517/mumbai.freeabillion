			...
			( function( $ ) {
				$( document ).ready( function() {
					...
					new ScrollMagic.Scene({
							triggerElement: "#wpb_single_image' . $uniqid . '",
							duration: "' . $duration . '",
							triggerHook: "' . $trigger_hook . '"
						})
						.setTween( "#wpb_single_image' . $uniqid . ' img", { ' . $opacity . $rotation . $horizontal_movement . $vertical_movement . ' } )
						.addTo( controller );
				}); // end document ready
			})( jQuery );
		</script>';
...
echo '
	<div class="' . esc_attr( trim( $css_class ) ) . '" id="wpb_single_image' . $uniqid . '">
