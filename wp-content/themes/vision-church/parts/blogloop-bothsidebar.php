...
<?php
	...
	$vision_church_options['vision_church_blog_meta_date_enable'] = isset($vision_church_options['vision_church_blog_meta_date_enable']) ? $vision_church_options['vision_church_blog_meta_date_enable'] : '1' ;
...
<br> <?php
	...
	<div class="postmetadata">
		<?php if($vision_church_options['vision_church_blog_meta_date_enable']) { ?>
		<h6 class="blog-date"><a href="<?php the_permalink(); ?>"><?php the_time(get_option( 'date_format' )) ?></a></h6>
		<?php } if( 1 == $vision_church_options['vision_church_blog_meta_author_enable'] ) { ?>
		<h6 class="blog-author"><strong><?php esc_html_e('by','vision-church'); ?></strong> <?php the_author_posts_link(); ?> </h6>
		<?php } ?>
		<?php if( 1 == $vision_church_options['vision_church_blog_meta_category_enable'] ) { ?>
		<h6 class="blog-cat"><strong><?php esc_html_e('in','vision-church'); ?></strong> <?php the_category(', ') ?> </h6>
		<?php } ?>
		<?php if( 1 == $vision_church_options['vision_church_blog_meta_comments_enable'] ) { ?>
