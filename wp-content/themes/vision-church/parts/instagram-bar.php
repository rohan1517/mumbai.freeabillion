...
$user = isset($vision_church_options['vision_church_footer_instagram_username']) ? $vision_church_options['vision_church_footer_instagram_username'] : '' ;
$acess = isset($vision_church_options['vision_church_footer_instagram_access']) ? $vision_church_options['vision_church_footer_instagram_access']  : '' ;
?>
<section class="footer-instagram-bar">
<div class="container"><div class="row">
<div class="footer-instagram-text"><h6><?php bloginfo('name') . esc_html_e(' on Instagram','vision-church')?></h6></div>
</div></div>
	<div class="instagram-feed">
		...
		else esc_html_e('An error has occoured...','vision-church');
		?>
		<div class="clear"></div>
	</div>	
</section>