...
function  vision_church_bloxdark_shortcode($attributes, $content)
{
...
add_shortcode("bloxdark", 'vision_church_bloxdark_shortcode');




function  vision_church_blox_shortcode($attributes, $content)
{
...
add_shortcode("blox", 'vision_church_blox_shortcode');