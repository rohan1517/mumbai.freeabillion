<?php 
function  vision_church_videorow_shortcode($attributes, $content) {
	...
	if ( $video_src == 'host' ) :
		...
		$out .= esc_html__('Your browser does not support the video tag. I suggest you upgrade your browser.','webnus-core');
...
add_shortcode("videorow", 'vision_church_videorow_shortcode');
?>