<?php
function vision_church_gmap ($atts, $content = null) {
	...
	wp_enqueue_script( 'vision-googlemap-api' );
	...
	jQuery(document).ready(function() {
		...
		function initMap() {
			...
			if ( Math.max(document.documentElement.clientWidth, window.innerWidth || 0) > 767 ) {
				var isDraggable = <?php echo $draggable; ?>;
			} else {
...
add_shortcode('gmap','vision_church_gmap');