...
//nav tab
add_shortcode( 'lefttab', 'vision_church_navtabgroup' );
function vision_church_navtabgroup( $atts, $content ){
	$GLOBALS['tab_count'] = 0;
...
add_shortcode( 'ltab', 'vision_church_ntabs' );
function vision_church_ntabs( $atts, $content ){
