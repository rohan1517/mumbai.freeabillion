<?php
function vision_church_subscribe ($atts, $content = null) {
...
?>
	...
	$input='<div class="subscribe-box-input"><input placeholder="'.esc_html__('YOUR E-MAIL','webnus-core').'" class="subscribe-box-email" type="text" name="'.$email_name.'"/><button class="subscribe-box-submit button medium" type="submit"><span>'.esc_html__('SUBSCRIBE','webnus-core').'</span></button></div>';
...
<?php
 ...
 add_shortcode('subscribe','vision_church_subscribe');
?>