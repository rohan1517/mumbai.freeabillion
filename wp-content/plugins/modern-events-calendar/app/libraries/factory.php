...
class MEC_factory extends MEC_base
{
    ...
    {
        $MEC = '<a href="'.$this->main->add_qs_vars(array('post_type'=>$this->main->get_main_post_type(), 'page'=>'MEC-settings'), $this->main->URL('admin').'edit.php').'">'._x('Settings', 'plugin link', 'mec').'</a>';
