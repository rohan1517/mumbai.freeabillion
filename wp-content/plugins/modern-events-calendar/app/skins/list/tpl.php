...
{
    echo json_encode(array('html'=>$items_html, 'end_date'=>$this->end_date, 'offset'=>$this->next_offset, 'count'=>count($this->events), 'current_month_divider'=>$current_month_divider));
    exit;
}
