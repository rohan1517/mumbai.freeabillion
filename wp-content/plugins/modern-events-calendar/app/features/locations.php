...
class MEC_feature_locations extends MEC_base
{
    ...
    public function register_taxonomy()
    {
        register_taxonomy(
            ...
            array(
                'label'=>__('Locations', 'mec'),
                'labels'=>array(
                    'name'=>__('Locations', 'mec'),
                    'singular_name'=>__('Location', 'mec'),
                    'all_items'=>__('All Locations', 'mec'),
                    'edit_item'=>__('Edit Location', 'mec'),
                    'view_item'=>__('View Location', 'mec'),
                    'update_item'=>__('Update Location', 'mec'),
                    'add_new_item'=>__('Add New Location', 'mec'),
                    'new_item_name'=>__('New Location Name', 'mec'),
                    'popular_items'=>__('Popular Locations', 'mec'),
                    'search_items'=>__('Search Locations', 'mec'),
                ),
    ...
    ?>
        <div class="mec-meta-box-fields" id="mec-location">
            <h4><?php _e('Event Location', 'mec'); ?></h4>
			<div class="mec-form-row">
				<select name="mec[location_id]" id="mec_location_id">
