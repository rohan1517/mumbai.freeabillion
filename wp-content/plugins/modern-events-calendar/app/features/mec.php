...
class MEC_feature_mec extends MEC_base
{
    ...
    public function menus()
    {
        ...
        add_submenu_page('mec-intro', __('Categories', 'mec'), __('Categories', 'mec'), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_category&post_type='.$this->PT);
        add_submenu_page('mec-intro', __('Labels', 'mec'), __('Labels', 'mec'), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_label&post_type='.$this->PT);
        add_submenu_page('mec-intro', __('Locations', 'mec'), __('Locations', 'mec'), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_location&post_type='.$this->PT);
        add_submenu_page('mec-intro', __('Organizers', 'mec'), __('Organizers', 'mec'), 'edit_others_posts', 'edit-tags.php?taxonomy=mec_organizer&post_type='.$this->PT);
