...
class MEC_feature_events extends MEC_base
{
    ...
    public function save_event($post_id)
    {
        ...
        $more_info = isset($_mec['more_info']) ? (strpos($_mec['more_info'], 'http') === false ? 'http://'.$_mec['more_info'] : $_mec['more_info']) : '';
    ...
    public function add_filters($post_type)
    {
        ...
        if(wp_count_terms($taxonomy)) wp_dropdown_categories(array(
            'show_option_all'=>__('Show all labels', 'mec'),
            'taxonomy'=>$taxonomy,
            'name'=>$taxonomy,
            'value_field'=>'slug',
            'orderby'=>'count',
        ...
        if(wp_count_terms($taxonomy)) wp_dropdown_categories(array(
            'show_option_all'=>__('Show all locations', 'mec'),
            'taxonomy'=>$taxonomy,
            'name'=>$taxonomy,
            'value_field'=>'slug',
            'orderby'=>'count',
        ...
        if(wp_count_terms($taxonomy)) wp_dropdown_categories(array(
            'show_option_all'=>__('Show all organizers', 'mec'),
            'taxonomy'=>$taxonomy,
            'name'=>$taxonomy,
            'value_field'=>'slug',
            'orderby'=>'count',
    ...
    public function filter_columns($columns)
    {
        ...
        $columns['location'] = __('Location', 'mec');
        $columns['organizer'] = __('Organizer', 'mec');
    ...
    public function sort($query)
    {
        ...
        {
            $query->set('meta_key', 'mec_end_date');
            $query->set('orderby', 'meta_value');
        }
    }
