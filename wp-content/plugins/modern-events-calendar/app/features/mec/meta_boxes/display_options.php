        ...
        <div class="mec-skins-options-container">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_list_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <select class="mec-col-4" name="mec[sk-options][list][style]" id="mec_skin_list_style" onchange="mec_skin_style_changed('list', this.value);">
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_carousel_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" name="mec[sk-options][carousel][autoplay]" id="mec_skin_carousel_autoplay" placeholder="<?php _e('eg. 3000 defult is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_carousel['autoplay']) && $sk_options_carousel['autoplay'] != '' ) echo $sk_options_carousel['autoplay']; ?>" />
                </div>
            </div>
            ...
            <div class="mec-skin-options-container mec-util-hidden" id="mec_slider_skin_options_container">
                ...
                <div class="mec-form-row">
                    ...
                    <input class="mec-col-4" type="number" name="mec[sk-options][slider][autoplay]" id="mec_skin_slider_autoplay" placeholder="<?php _e('eg. 3000 defult is 3 second', 'mec'); ?>" value="<?php if(isset($sk_options_slider['autoplay']) && $sk_options_slider['autoplay'] != '' ) echo $sk_options_slider['autoplay']; ?>" />
                </div>
            </div>
