            ...
            <div class="mec-options-fields">
                ...
                <div class="mec-form-row">
                    <label>
                        ...
                        <input value="1" type="checkbox" name="mec[settings][fes_section_cost]" <?php if(!isset($settings['fes_section_cost']) or (isset($settings['fes_section_cost']) and $settings['fes_section_cost'])) echo 'checked="checked"'; ?> /> <?php _e('Event Cost', 'mec'); ?>
                    </label>
                </div>
                <div class="mec-form-row">
                    <label>
...
jQuery("#mec_settings_form").on('submit', function(event)
{
    ...
    jQuery("#mec_settings_form_button").addClass('loading').text("<?php echo esc_js(esc_attr__('Saved', 'mec')); ?>");
    ...
    jQuery.ajax(
    {
        ...
        success: function(data)
        {
            ...
            setTimeout(function(){
                jQuery("#mec_settings_form_button").removeClass('loading').text("<?php echo esc_js(esc_attr__('Save Changes', 'mec')); ?>");
